...
<ol>
    ...
    "SMTP_PASSWORD" - пароль, сгенерированный службой gmail.com. Можно сгенерировать в настройках двухфакторной аутентификации самой почты или воспользоваться моими настройками.
    </li>
</ol>
